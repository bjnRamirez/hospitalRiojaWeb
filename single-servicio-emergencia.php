        ...
        <aside class="vista-servicio__secciones">
            <div>
                ...
                <ul class="secciones__lista">
                    ...
                    <li>
                        <div class="section-progress-indicator">
                            <a href="#prestacionesEmergencia" class="section-progress-indicator__element">Prestaciones</a>
                            <span class="section-progress-indicator__progress"></span>
                        </div>
                    </li>
                    <li>
                    ...
                    <li>
                        <div class="section-progress-indicator">
                            <a href="#multimedia" class="section-progress-indicator__element">Multimedia</a>
                            <span class="section-progress-indicator__progress"></span>
                        </div>
                    </li>
                    <li>
